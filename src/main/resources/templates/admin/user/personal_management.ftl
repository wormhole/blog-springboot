...
<head>
    ...
    <link rel="stylesheet" href="/static/admin/css/user/personal_management.css"/>
...
<script type="text/javascript" src="/static/admin/js/user/personal_management.js"></script>
</body>
</html>