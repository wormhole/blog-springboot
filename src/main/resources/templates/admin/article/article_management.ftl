...
<head>
    ...
    <link rel="stylesheet" href="/static/admin/css/article/article_management.css"/>
...
<script type="text/javascript" src="/static/admin/js/article/article_management.js"></script>
</body>
</html>