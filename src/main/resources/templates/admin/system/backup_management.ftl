...
<head>
    ...
    <link rel="stylesheet" href="/static/admin/css/system/backup_management.css"/>
...
<script type="text/javascript" src="/static/admin/js/system/backup_management.js"></script>
</body>
</html>